      ...
      <main className="relative z-10 flex-1 pt-16">
        <div className="h-[calc(100vh-4rem)] flex overflow-hidden">
          ...
          >
            ...
            {/* Contract / negotiation panel — mobile only (via Contracts tab) */}
            {tab === "contracts" && (
              <div className="flex-1 overflow-y-auto p-4 lg:hidden">
                {activeConvo ? (
                  ...
                  <p className="text-sm text-slate-400 text-center mt-10">
                    Select a conversation to see its negotiation and contract.
                  </p>
                )}
              </div>
            )}
            ...
            {/* Message Input */}
            <div
              className={`px-3 py-3 sm:px-6 sm:py-4 border-t border-white/5 bg-surface-dark/30 backdrop-blur-xl ${
                tab === "contracts" ? "hidden lg:block" : ""
              }`}
            >
              {contactMasked && (
          ...
          {/* Right: Contract / Booking Details — desktop sidebar */}
