        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="bg-surface-dark/50 backdrop-blur-xl border border-white/5 rounded-2xl p-12 text-center">
              <span className="material-icons text-5xl text-slate-700 mb-3 block">confirmation_number</span>
              <h3 className="text-lg font-semibold text-white mb-2">No tickets yet</h3>
              <p className="text-sm text-slate-500">When you purchase event tickets, they will appear here.</p>
            </div>
          ) : (
            /* Tickets Grid */
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold ${
                          ...
                          <span className={`w-1.5 h-1.5 rounded-full ${
                            ticket.status === "ACTIVE" ? "bg-emerald-400" : ticket.status === "USED" ? "bg-slate-400" : "bg-red-400"
                          }`} />
